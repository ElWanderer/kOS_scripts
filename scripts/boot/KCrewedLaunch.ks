...
pOut("KCrewedLaunch.ks v1.0.0 20200911").
...
FOR u IN LIST("node.ks", "rdz_dock.ks") { loadScript(u). }

// set these values ahead of launch
GLOBAL NEW_NAME IS "Hermes 2".
GLOBAL SAT_AP IS 130000.
GLOBAL SAT_PE IS 130000.
GLOBAL SAT_I IS 0.
GLOBAL SAT_LAN IS -1.
GLOBAL SAT_W IS -1.
